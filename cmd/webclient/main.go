...
import (
	...
	"github.com/kdudkov/goasae/pkg/gpsd"
	...
	"github.com/kdudkov/goasae/pkg/log"
...
func main() {
	conf := flag.String("config", "goasae_client.yml", "name of config file")
	...
	viper.SetDefault("me.platform", "GoASAE_client")
